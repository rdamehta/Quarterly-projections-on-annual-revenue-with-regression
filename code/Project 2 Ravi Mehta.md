...
I performed some exploratory statistical analysis and madee some plots, such as histograms of transaction totals, bottles sold, etc.

    I had to clean and munge the data first. Checking for Missing values and NaNs
...
#### Summary
On average the difference in yearly sales for Iowa liquor stores from 2016 to 2015 was 9,215 dollars
thats a 9,215 dollars per store on average increase in yearly sales in 2016, very little difference bewteen my Ridge Regression and  and linear regression models, most likely because jan - March sales were so heavily correlated with total Sales.
